...
export type TranslationStringsProjects = `projects.${LocaleSubKeys["projects"]}`;
export type TranslationString = TranslationStringsHome | TranslationStringsSidebar | TranslationStringsProjects;
...
function splitLocaleKey(key: TranslationString) {
    return key.split(".") as [keyof LocaleMap, keyof LocaleMap[keyof LocaleMap]];
}
