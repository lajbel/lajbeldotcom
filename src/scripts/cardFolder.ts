...
function toggleFolderCardsActive(cardFolder: HTMLDivElement, toggle: boolean) {
    const cardsContainer = cardFolder.querySelector<HTMLDivElement>(
        ".card-folder__cards-container",
    );
...
function onCardFolderClick(cardFolder: HTMLDivElement) {
    ...
    toggleFolderCardsActive(
        cardFolder,
        cardFolder.classList.contains("card-folder--active"),
    );
}
